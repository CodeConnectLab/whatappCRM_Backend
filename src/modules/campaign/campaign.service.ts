...
export async function enqueueCampaign(campaignId: string, companyId: string, userId?: string) {
...
export async function pauseCampaign(campaignId: string, companyId: string) {
  await CampaignModel.updateOne(
