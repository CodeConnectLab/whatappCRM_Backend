...
const envSchema = z.object({
  ...
  S3_FORCE_PATH_STYLE: z.string().optional().transform((v) => v === "true" || v === "1"),
...
function isS3MediaConfigured() {
  return Boolean(
    env.S3_BUCKET.length > 0 && env.AWS_ACCESS_KEY_ID.length > 0 && env.AWS_SECRET_ACCESS_KEY.length > 0
  );
}
export {
  env,
