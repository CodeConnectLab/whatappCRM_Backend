...
metaWhatsappConfigSchema.index({ webhookVerifyToken: 1 }, { unique: true, sparse: true, partialFilterExpression: { webhookVerifyToken: { $type: 'string' } } });
export const MetaWhatsappConfigModel = getModel('MetaWhatsappConfig', metaWhatsappConfigSchema);
